...
import { getBeds, getStudents, updateBed } from '../../services/api';
import { BedDouble, User, Check, X, Clock } from 'lucide-react';

const BedCard: React.FC<{ bed: BedType; student?: Student; onUpdate: (docId: string, bed: Partial<BedType>) => void }> = ({ bed, student, onUpdate }) => {
...
const BedManagement: React.FC = () => {
    ...
    const handleUpdateBed = async (docId: string, data: Partial<BedType>) => {
        await updateBed(docId, data);
        fetchData();
    };
